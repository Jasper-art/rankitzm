...
export default function PaymentManualScreen() {
  ...
  return (
    <div style={{ minHeight: '100dvh', width: '100%', background: t.bg, color: t.text }}>
      <header style={{
        ...
        <div>
          <div style={{ fontSize: 16, fontWeight: 700 }}>Manual Payment</div>
          <div style={{ fontSize: 11, color: t.textMuted }}>Record manual payments</div>
        </div>
      </header>
      <main style={{ padding: 24, maxWidth: 720, margin: '0 auto' }}>
        <div style={{ background: t.surface, border: `1px solid ${t.border}`, borderRadius: 12, padding: 24 }}>
          <p style={{ color: t.textMuted }}>This is a placeholder screen. Implement manual payment entry here.</p>
          <button
            onClick={() => navigate(-1)}
            style={{
              marginTop: 14,
