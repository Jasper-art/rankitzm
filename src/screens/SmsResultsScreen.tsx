  ...
  return (
    <div style={{ minHeight: '100dvh', width: '100%', background: t.bg, color: t.text }}>
      <header style={{
        ...
        <div>
          <div style={{ fontSize: 16, fontWeight: 700 }}>SMS Results</div>
          <div style={{ fontSize: 11, color: t.textMuted }}>Send results to parents via SMS</div>
        </div>
      </header>
      <main style={{ padding: 24, maxWidth: 720, margin: '0 auto' }}>
        <div style={{ background: t.surface, border: `1px solid ${t.border}`, borderRadius: 12, padding: 24 }}>
          <p style={{ color: t.textMuted }}>This screen is a placeholder for SMS results functionality.</p>
          <button
            onClick={() => navigate(-1)}
            style={{
              marginTop: 14,
