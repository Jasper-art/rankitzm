    ...
    <div style={{ minHeight: '100dvh', width: '100%', background: t.bg, color: t.text }}>
      <header style={{
        ...
        <div>
          ...
          <div style={{ fontSize: 11, color: t.textMuted }}>Reset your account password</div>
        </div>
      </header>
      <main style={{ padding: 24, maxWidth: 520, margin: '0 auto' }}>
        <div style={{ background: t.surface, border: `1px solid ${t.border}`, borderRadius: 12, padding: 24 }}>
          <p style={{ color: t.textMuted }}>This is a placeholder screen. Implement password reset flow here as required.</p>
          <button
            onClick={() => navigate('/login')}
            style={{
              marginTop: 14,
